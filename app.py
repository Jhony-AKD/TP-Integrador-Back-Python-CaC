#--------------------------------------------------------------------
# Instalar con: pip install Flask    (Copiar pip instal... y ejecutarlo en una nueva terminal)
from flask import Flask, request, jsonify, render_template
#from flask import request

# Instalar con: pip install flask-cors    (Copiar pip instal... y ejecutarlo en una nueva terminal)
from flask_cors import CORS

# Instalar con: pip install mysql-connector-python    (Copiar pip instal... y ejecutarlo en una nueva terminal)
import mysql.connector

# Si es necesario: pip install Werkzeug    (Si es necesario, copiar pip instal... y ejecutarlo en una nueva terminal)
...
catalogo = Catalogo(host='JhonyAKD.mysql.pythonanywhere-services.com', user='JhonyAKD', password='17407255ab', database='JhonyAKD$miapp')
...
RUTA_DESTINO = '/home/JhonyAKD/mysite/static/imagenes'
